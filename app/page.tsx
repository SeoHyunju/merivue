    ...
    <main className="min-h-screen bg-[#f8f5ef] text-[#17233c]">
      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-black/5 bg-[#f8f5ef]/90 backdrop-blur-md">
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-6 lg:px-8">
          ...
          <Link
            href="/reservation"
            className="inline-flex h-10 items-center justify-center bg-[#17233c] px-5 text-sm font-medium text-white transition-colors hover:bg-[#263756] sm:px-6"
          >
            예약하기
          </Link>
        </div>
        ...
        <div className="relative mx-auto grid w-full max-w-7xl items-center gap-16 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:py-24">
          ...
          <div>
            ...
            <p className="mt-7 max-w-xl text-base leading-8 text-[#596174] md:mt-8 md:text-lg">
              MERIVUE는 축의금 접수부터 하객 응대, 정확한 정산과
              인계까지 예식의 시작을 품격 있게 책임지는 프리미엄 축의대
              서비스입니다.
            </p>
